    ...
    Box(modifier = Modifier.fillMaxWidth()) {
        Row(modifier = Modifier.align(alignment = if (viewModel.isLocalUser) Alignment.TopEnd else Alignment.TopStart)) {
            ...
            Box(
                ...
                androidx.compose.animation.AnimatedVisibility(visible = viewModel.showMessageSendStatusIcon) {
                    ...
                    when(viewModel.messageStatus) {
                        ...
                        MessageStatus.SENT -> {
                            Icon(
                                ...
                                painterResource(
                                    id =
                                    R.drawable.azure_communication_ui_chat_ic_fluent_message_delivered_10_filled
                                ),
